...
while key != 113:
    ...
    # orgimgrot = np.rot90(image)
    # orig_images=orgimgrot
    orig_images.append(image)
    print(orig_images[0].shape)

    # print('222222222222',orig_images[0].shape[1])

    # print('111111111111111111',orig_images[0])
    # cv2.imshow('video',image)
    resize = cv2.resize(image, (300, 300))

    # img90=np.rot90(resize)

    # img = image.img_to_array(resize)
    input_images.append(resize)
    # print('22222222222222222input',input_images[0].shape)

    # input_images.append(img90)
    input_images = np.array(input_images)
    # print('111111111111111111',input_images)
    # cv2.imshow('2222222222',input_images[0])
